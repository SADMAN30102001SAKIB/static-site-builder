    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-800 shadow-md transform transition-transform duration-300 ease-in-out ${
          sidebarCollapsed || (isMobile && !sidebarCollapsed) ? '-translate-x-full' : 'translate-x-0'
        } md:relative md:translate-x-0`}
      >
        <div className="p-4 h-full flex flex-col">
          <div className="flex items-center justify-between mb-8">
            <Link href="/dashboard" className="font-bold text-xl text-[rgb(var(--primary))]">
              WebsiteBuilder
            </Link>
            <button
          ...
          <nav className="flex-1 space-y-1">
            ...
            >
              <svg className="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-[rgb(var(--primary))]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              >
                <svg className="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="ml-4 md:ml-0">
                <h1 className="text-lg font-medium text-gray-900 dark:text-gray-100">Dashboard</h1>
              </div>
            </div>
