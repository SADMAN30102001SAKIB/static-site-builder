...
export default function ProfilePage() {
  ...
  const validateForm = (values) => {
    ...
    if (values.image && !/^(https?:\/\/)?([\da-z.-]+)\.([a-z.]{2,6})([/\w .-]*)*\/?$/.test(values.image)) {
    ...
    <Container maxWidth="max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Manage your personal information and how it appears across the website builder.
        </p>
      </div>
        ...
        <div className="md:col-span-1">
          <Card>
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">{values.name}</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{values.email}</p>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center py-2">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Update your password for enhanced security</p>
                </div>
                <Button
                  variant="outline"
                  size="sm"
              ...
              <div className="flex justify-between items-center py-2">
                <div>
                  <h4 className="text-sm font-medium text-gray-900 dark:text-white">Account Data</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Download or delete your account data</p>
                </div>
                <Button
                  variant="outline"
                  size="sm"
